...
$(function(){
    ...
    $('#cancleBtn').click(function(){
    	$(location).attr('href','${pageContext.request.contextPath}/userQA/qaboardReplyForm.do');
    });
...
<hr />
<form class="form-horizontal" role="form" action="${pageContext.request.contextPath }/userQA/insertQAReply.do" method="post">
	...
	<div class="form-group"> 
		<div class="col-sm-offset-2 col-sm-10">
			...
			<button type="button" class="btn btn-danger" id="cancleBtn">취소</button>
