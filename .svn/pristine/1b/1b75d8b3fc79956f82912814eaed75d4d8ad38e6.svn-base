...
$(function(){
    ...
    $('form').submit(function(){
    	if($('#qa_title').val() == ""){
  	 	...
  	 	$('form').append("<input type='textarea' name='bo_content' value='"+contentval+"'/>");
...
<body>
<form class="form-horizontal" role="form" action="${pageContext.request.contextPath }/userQA/insertQABoard.do" method="post">
