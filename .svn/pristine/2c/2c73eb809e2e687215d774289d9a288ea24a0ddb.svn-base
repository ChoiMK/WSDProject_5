...
<script type="text/javascript">
 	$(function(){
		$('img').click(function(){
			...
			$(location).attr('href','${pageContext.request.contextPath}/admin/reference/adReferenceView.do?ref_no='+ref_no);
		});
		...
		$('form[name=searchForm]').submit(function(){
			$(location).attr('href','${pageContext.request.contextPath}/admin/reference/adReferenceList.do?nt_no='+nt_no);
		});
	...
	<table width="1000" border="0" cellpadding="0" cellspacing="0">
		<tr valign="top">
			...
			<td width="790"> 
					...
					<article class="col-xs-12 col-sm-6 col-md-3">
						            <div class="panel panel-default">
						                ...
						                <c:forEach items="${referenceInfo.attachFileRoomList}" var="fileItem">
						                        <img style='width:140px; height:120px' src="${pageContext.request.contextPath}/file/${fileItem.file_save_name}">
						                </c:forEach>
               ...
               <form action="${pageContext.request.contextPath }/admin/reference/adReferenceList.do" method="post" class="form-inline pull-right" name="searchForm">
