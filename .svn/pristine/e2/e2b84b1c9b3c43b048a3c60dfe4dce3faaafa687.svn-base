      ...
      <div id="header">
         <div class="top_bn">
            <ul>
               ...
               <li><a href="${pageContext.request.contextPath }/user/main.do"><img src="${pageContext.request.contextPath }/image/admin_homelink.jpg" /></a></li>
               <li><a href="${pageContext.request.contextPath }/adminMain/admin.do"><img src="${pageContext.request.contextPath }/image/admin_logout.jpg" /></a></li>
            </ul>
         </div>
         <div class="logo">
         ...
         <div class="gnb">
            <ul>
               ...
               <li><a href="#" id="ADnoticeBtn">공지사항</a></li>
               <li><a href="#" id="ADBoardBtn">게시판</a></li>
               <li><a href="#" id="ADReference">자료실</a></li>
               <li><a href="#" id="ADQA">Q&A</a></li>
               <li><a href="#" id="ADStat">통계 분석</a></li>
            </ul>
         </div>
      </div>
   </div>
...
$(function(){
   ...
   $('#ADQA').click(function(){
	...
	$('#AdminInfo').click(function(){
		$(location).attr('href', '${pageContext.request.contextPath}/admin/memberMgr.do');
	});
	$('#ADStat').click(function(){
		$(location).attr('href', '${pageContext.request.contextPath}/statistics/memberstatistics.do');
	});
	$('#ADStat').click(function(){
		$(location).attr('href', '${pageContext.request.contextPath}/statistics/memberstatistics.do');
	});
