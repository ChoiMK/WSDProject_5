				...
				<ul class="nav navbar navbar-top-links navbar-right mbn">
					...
					<li class="dropdown">
						...
						<ul class="dropdown-menu" role="menu">
							<li><a id="profile" href="#"><i class="fa fa-user"></i>프로필관리</a></li>
		...
		<c:if test="${empty LOGIN_MEMBERINFO}">
			<div class="loginForm nav navbar navbar-top-links navbar-right"
				...
				<ul>
				    ...
				    <li>&nbsp;</li>	
			        <li class="dropdown">
			        	<button type="button" id="joinBtn" class="btn btn-warning btn-sm">회원가입</button>
				    </li>
				</ul>	    
			</div>
		</c:if>
...
<script type="text/javascript">
	$(function(){
		...
		$("#loginBtn").click(function(){
			...
			var $frm = $('<form action="${pageContext.request.contextPath}/join/loginCheck.do"/>')
		...
		$('#profile').click(function(){
			window.open("${pageContext.request.contextPath}/member/memberProfile.do?mem_id=${LOGIN_MEMBERINFO.mem_id}", "Profile", 
			"width=600, height=700, left=350, top=100, scrollbars=yes");
		});
