...
$(function(){
    ...
    $('form').submit(function(){
		...
		$(this).append('<input type="hidden" name="qa_group" value="${qaInfo.qa_group }"/>');
		$(this).append('<input type="hidden" name="qa_depth" value="${qaInfo.qa_depth }"/>');
		$(this).append('<input type="hidden" name="qa_seq" value="${qaInfo.qa_seq }"/>');
    });
});
</script>
</head>
...
<div class="row">
	 ...
	 <div class="col-sm-8">
    	...
    	<p class="form-control-static">${qaInfo.qa_title }</p>
	 </div>
	 <div class="col-sm-1">
...
<hr />
<form class="form-horizontal" role="form" action="${pageContext.request.contextPath }/user/qaboard/insertQAReplyInfo.do" method="post">
	...
	<div class="form-group">
		...
		<div class="col-sm-10"> 
			<input type="text" class="form-control" id="qa_nickname" name="qa_nickname" value="${LOGIN_MEMBERINFO.mem_name }">
		</div>
	</div>
	<div class="form-group">
