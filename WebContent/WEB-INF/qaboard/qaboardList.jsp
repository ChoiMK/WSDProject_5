...
$(function(){
	$('#listClick').on('click', 'td[name=td]', function(){
		...
		$(location).attr('href','${pageContext.request.contextPath}/userQA/qaboardView.do?qa_no='+qa_no+'&rnum=' + rnum );
	...
	$('form[name=searchForm]').submit(function(){
		...
		$(location).attr('href','${pageContext.request.contextPath}/userQA/qaboardList.do?qa_no='+qa_no);
	});
...
<div >
<form action="${pageContext.request.contextPath }/userQA/qaboardList.do" method="post" class="form-inline pull-right" name="searchForm">
